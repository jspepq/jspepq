  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>Juzgado Segundo Pluripersonal Penal, Quetzaltenango</b></a>
            <!--logo end-->
            ...
            <div class="top-menu">
            	...
            	<ul class="nav pull-right top-menu">
                    <li><div class="nomb">
                    <b><?php //header('Content-Type: text/html; charset=ISO-8859-1'); 
                        echo "Bienvenid@  ".$row['nombre']; ?></b>
                </div></li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="index.php"><img src="assets/img/oj.gif" class="img-circle" width="60"></a></p>
